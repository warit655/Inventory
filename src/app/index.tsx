...
const styles = StyleSheet.create({
  ...
  aiBtn: { backgroundColor: '#1e2d3e', borderRadius: 12, paddingHorizontal: 15, height: 45, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#66c0f4' },
  aiBtnText: { color: '#66c0f4', fontSize: 14, fontWeight: 'bold', letterSpacing: 1 },
